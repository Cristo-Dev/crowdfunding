...
# Run this script from root with `python3 -m contracts.utils.compile_contracts`

from ..crowdfund_contract import FundingProject
# from contracts.crowdfund_contract import FundingProject
from ..escrow import EscrowAccount
# from contracts.escrow import EscrowAccount
