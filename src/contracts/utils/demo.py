...
class LoggingAlgodClient(algod.AlgodClient):
    def compile(self, source_code):
        print("Compiling TEAL code:")
        print(source_code)
        print("Endpoint URL:", self.algod_address + "/v2/teal/compile")
        return super().compile(source_code)

print("LoggingAlgodClient's algod_request method called!")

algod_client = LoggingAlgodClient(algod_token=ALGOD_TOKEN, algod_address=ALGOD_ADDRESS, headers=HEADERS)
...
class DemoApp():
    ...
    def run(self, is_successful=True, is_sponsored=True):
        ...
        app_args = [
            ...
            encoding.decode_address(self.accounts['platform'].address),
