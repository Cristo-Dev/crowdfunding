...
const ProjectPage = () => {
    useEffect(() => {
        // Run this effect on client-side after the component has mounted
            ...
            loading? (
                ...
                <MDBCol md='8'>
                    ...
                    <MDBContainer className='text-light pb-3'>
                        The project&apos;s fundraising ends on {new Date(project.endDate * 1000).toLocaleString()}. Hurry up if you want to contribute!
